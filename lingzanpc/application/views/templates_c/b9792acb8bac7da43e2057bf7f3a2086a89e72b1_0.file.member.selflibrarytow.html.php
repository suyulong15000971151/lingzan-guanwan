<?php
/* Smarty version 3.1.30, created on 2018-01-17 17:55:12
  from "D:\lingzanpc\application\views\templates\member\member.selflibrarytow.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a5f1d807220c4_74326433',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b9792acb8bac7da43e2057bf7f3a2086a89e72b1' => 
    array (
      0 => 'D:\\lingzanpc\\application\\views\\templates\\member\\member.selflibrarytow.html',
      1 => 1516181871,
      2 => 'file',
    ),
  ),
...
function content_5a5f1d807220c4_74326433 (Smarty_Internal_Template $_smarty_tpl) {
			...
			<div class="pick-box">
				<div class="pick-content" style="height:600px;">
					...
					<div class="pick-show">
						...
						<input type="hidden" name="libid" id="libid" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['libid'];?>
"/>
							...
							<div class="select">
								<div class="select-show child">
									...
									<div class="select-box">
										<div class="item addselect"><?php echo $_smarty_tpl->tpl_vars['data']->value['libname'];?>
</div>
...
/image/laught_03.png" alt="" style="position:relative;"/>
		...
		<div class="manpeople">
			<div class="man-box">
				<!--<?php if ($_smarty_tpl->tpl_vars['userInfo']->value['userid'] == $_smarty_tpl->tpl_vars['user']->value['userid']) {?>
...
"><i>返回</i></a>
				...
				<!--<h1><?php echo $_smarty_tpl->tpl_vars['data']->value['libname'];?>
</h1>-->
				<!--<p><?php echo $_smarty_tpl->tpl_vars['library']->value['count'];?>
个区域</p>-->
...
?>
				...
				<div class="pro-explain">
					<p><?php echo $_smarty_tpl->tpl_vars['data']->value['desc'];?>
</p>
					<em>全文》</em>
				</div>
				
				
				<i onclick="javascript:window.location.href='/member/library'" title="返回"></i>
				<!-- <span title="分享"></span> -->
				
				<!-- <div class="files">
					<a href="javascript:;" class="add"><img src="<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/image/up.png" title="上传文件" alt="" /></a><p><a href="javascript:;" title="项目文件"></a> <em title="项目文件">2</em></p>
...
" />
			...
			<?php if ($_smarty_tpl->tpl_vars['library']->value['list'] != '') {?>
			<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['library']->value['list'], 'item');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['item']->value) {
?>
			<div class="box man-item project_<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
">
				<div class="item-box">
					<a href="/library/project/<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
">
						<h4><?php echo $_smarty_tpl->tpl_vars['item']->value['area'];
echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
</h4>
						<div class="big-img">
							<?php if ($_smarty_tpl->tpl_vars['item']->value['pic'] != '') {?> <img src="<?php echo $_smarty_tpl->tpl_vars['item']->value['pic'];?>
" alt="<?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
" /> <?php } else { ?>  <img src="<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/image/li_image.jpg" alt="" /> <?php }?>
						</div>
						<div class="small">
...
?>
					...
					<?php if ($_smarty_tpl->tpl_vars['userInfo']->value['userid'] == $_smarty_tpl->tpl_vars['userid']->value) {?>
					<div class="edits" onClick="editProject(<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
)">编辑</div>
					<!-- <div class="edidele" onClick="deleteProject(<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
)">删除</div> -->
					<div class="edidele" onClick="copyProject(<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
)">复制成新区域</div>
...
>
		<?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/js/librarythree.js"><?php echo '</script'; ?>
>
		<?php echo '<script'; ?>
  ...
  $(".pro-explain p").text(slicetext+"...")
	...
	$(".sub-box .pro-explain em").click(function(){
		...
		function cpProject(projectId) {
			...
			var libid = <?php echo $_smarty_tpl->tpl_vars['data']->value['libid'];?>
;
				...
				$('.saves').click(function(){
			        ...
			        success:function(ret){
			            ...
			            if(code != 200){
			             ...
			             // window.location.href = "/member/selflibrarytow/"+<?php echo $_smarty_tpl->tpl_vars['data']->value['libid'];?>
; 
					...
					if (h<=scroll+client) { // 到达底部时,加载新内容
						...
						$.ajax({
							...
							data: {
								...
								libid: "<?php echo $_smarty_tpl->tpl_vars['data']->value['libid'];?>
",
								p: p,
...
";
				var myUserId = "<?php echo $_smarty_tpl->tpl_vars['userInfo']->value['userid'];?>
";
				var create = "<?php echo $_smarty_tpl->tpl_vars['create']->value;?>
";
