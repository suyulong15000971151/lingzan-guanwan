<?php
/* Smarty version 3.1.30, created on 2018-01-17 15:32:15
  from "D:\lingzanpc\application\views\templates\member\member.follow.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a5efbff196e02_60955694',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b066ed55f2f8f4f48f3b8ded5106da154ac84308' => 
    array (
      0 => 'D:\\lingzanpc\\application\\views\\templates\\member\\member.follow.html',
      1 => 1516174246,
      2 => 'file',
    ),
  ),
...
function content_5a5efbff196e02_60955694 (Smarty_Internal_Template $_smarty_tpl) {
...
">他的粉丝</a>
			...
			<form action="/member/follow/<?php echo $_smarty_tpl->tpl_vars['userInfo']->value['userid'];?>
" method="get">
			<div class="sub-sear">
				<button></button>
...
?>
					...
					<?php if ($_smarty_tpl->tpl_vars['userInfo']->value['userid'] == $_smarty_tpl->tpl_vars['userid']->value) {?>
					<div class="edit" onClick="cancelFollow(<?php echo $_smarty_tpl->tpl_vars['item']->value['user']['userid'];?>
)">取消关注</div>
					<?php }?>
				</div>
			</div>
							...
							if(!isEmptyObject(data.errmsg)) {
								$.each(data.errmsg, function(i, n) {
									...
									if(user.userid != <?php echo $_smarty_tpl->tpl_vars['userid']->value;?>
										...
										// str += '<a href="/member/library">';
										str += '<div class="edit" onClick="cancelFollow('+user.userid+')">取消关注</div>';
									}
