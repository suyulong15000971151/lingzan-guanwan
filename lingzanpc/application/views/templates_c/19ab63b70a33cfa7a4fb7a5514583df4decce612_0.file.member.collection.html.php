<?php
/* Smarty version 3.1.30, created on 2018-01-23 17:21:42
  from "D:\lingzanpc\application\views\templates\member\member.collection.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a66fea6386789_04720375',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '19ab63b70a33cfa7a4fb7a5514583df4decce612' => 
    array (
      0 => 'D:\\lingzanpc\\application\\views\\templates\\member\\member.collection.html',
      1 => 1516699298,
      2 => 'file',
    ),
  ),
...
function content_5a66fea6386789_04720375 (Smarty_Internal_Template $_smarty_tpl) {
						...
						<div class="pick-left">
							<div class="back-one">
								<div class="img-load">
									...
									<p id="chooseFile" class="btn pk">点击上传图片</p>
								</div>
								<div class="title-item">
									<span>*</span>
									<input type="text" placeholder="产品型号" name="proname" class="proname" style="width:100%;opacity: 1;" />
								</div>
								<div class="title-item">
									<span>*</span>
									<i></i>
							...
							<div class="back-two">
								<div class="item">
									...
									<div class="unit unit-top"><span>单位</span> <i></i>
										<div class="unit-sub">
											<a href="javascript:;">件</a>
											<a href="javascript:;">米</a>
											<a href="javascript:;">平米</a>
											<a href="javascript:;">公斤</a>
										</div>
									</div>
								</div>
								
								<!--<input type="text" placeholder="链接" name="link" class="link" />-->
								<div class="item"><input type="text" placeholder="材质" name="material" class="material" /></div>
								<div class="item"><input type="text" placeholder="规格" name="size" class="size" /></div>
								<div class="item"><input type="text" placeholder="产品项目名称" name="model" class="model" disabled="disabled"/>
								   <div class="unit project"> <i></i>
										<div class="unit-sub" style="width:160px;right:2px">
											<a href="javascript:;">毫米</a>
											<a href="javascript:;">厘米</a>
											<a href="javascript:;">分米</a>
											<a href="javascript:;">米</a>
										</div>
									</div>
								</div>
...
">
    ...
    <div class="man-sub">
		<?php if ($_smarty_tpl->tpl_vars['userInfo']->value['userid'] == $_smarty_tpl->tpl_vars['userid']->value) {?>
		<a href="/member/collection" class="actv">我的产品</a>
		<?php } else { ?>
		<a href="/member/collection/<?php echo $_smarty_tpl->tpl_vars['userInfo']->value['userid'];?>
" class="actv">他的产品</a>
		<?php }?>
...
">他的采集</a>
		...
		<?php if ($_smarty_tpl->tpl_vars['userInfo']->value['userid'] == $_smarty_tpl->tpl_vars['userid']->value) {?>
		<form action="/member/collection" method="get">
		<?php } else { ?>
		<form action="/member/collection/<?php echo $_smarty_tpl->tpl_vars['userInfo']->value['userid'];?>
" method="get">
		<?php }?>
		    <div class="sub-sear">
				<button></button>
...
>
	//这里是产品弹窗
	$("#pick .pick-left .back-two .item .unit").click(function(){
		$(this).find(".unit-sub").slideToggle()
	})
	$("#pick .pick-left .back-two .item .unit-top a").click(function(){
		var texts=$(this).text();
		$(this).parents(".unit").find("span").text(texts)
	})
	
	$("#pick .pick-left .back-two .item .project a").click(function(){
		var texts=$(this).text();
		$(this).parents(".item").find("input").val(texts)
	})
		...
		function editPro(proid) {
			...
			$('.sub-icon').removeClass('addselect');
			$('.submit').prev('p').remove();
			$.ajax({
		...
		$('.uploads-pro').click(function() {
			...
			$('#pick .pick-box .pick-content .pick-title span').text('产品信息编辑');
			$('#productId').val('');
			$('#oldLibid').val('');
			$('#oldProid').val('');
